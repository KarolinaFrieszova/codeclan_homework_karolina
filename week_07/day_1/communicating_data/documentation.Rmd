...
In report we consider the pattern of bike hires over time and how bike hire patterns differ between bike rider demographics of trip type. 
Secondly, we look at the geographical spread of the start points of bike hires.
...
- By zooming in, we can see the stations and how many times the bikes where picked from which station. 
...
To conclude, graphs indicate that bike hire is fairly popular annual transportation choice.
The first graph indicate that bikes were used less frequently over the winter months, which can be due to the weather conditions.
